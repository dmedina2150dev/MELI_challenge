  ...
  return (
    <div className='w-full px-16 md:px-0 max-h-screen flex items-center justify-center'>
      <div className='bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg'>
        ...
        <p className='text-lg md:text-3xl lg:text-5xl font-bold tracking-wider text-gray-500 mt-4'>Página no encontrada</p>
        <p className='text-gray-500 mt-4 pb-4 border-b-2 text-center text-sm'>Lo sentimos no se encontro lo que estas buscando.</p>
